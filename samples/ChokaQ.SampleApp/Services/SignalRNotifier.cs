...
public class SignalRNotifier(IHubContext<ChokaQHub> hubContext, ILogger<SignalRNotifier> logger) : IChokaQNotifier
{
    private readonly IHubContext<ChokaQHub> _hubContext = hubContext;
